...
export const Icon = ({ name, size = 22, color = colors.ink, filled = false }: Props) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      ...
      {name === 'assistant' && (
        <>
          <Path d="M20 12.5a7 7 0 01-7 7H8.5L4.5 22v-4.3A7 7 0 019 4.8" {...s} />
          <Path d="M17 2.5l.9 2.1 2.1.9-2.1.9-.9 2.1-.9-2.1-2.1-.9 2.1-.9z" {...s} fill={solid} />
          <Path d="M9.5 12h5" {...s} />
        </>
      )}
      {name === 'swap' && (
        <>
          <Path d="M4 9h13l-3.5-3.5M20 15H7l3.5 3.5" {...s} />
        </>
      )}
      {name === 'refresh' && (
        <>
