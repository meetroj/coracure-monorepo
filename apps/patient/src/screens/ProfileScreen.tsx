...
export const ProfileScreen = () => {
  ...
  const handleDataDeletion = () => {
    Alert.alert(
      'Statutory Data Deletion (PT-03-03)',
  ...
  const handleDataExport = () => {
    Alert.alert(
      'Export Patient Health Archive (PT-21-01)',
      'A secure password-protected ZIP containing your consultation summaries, uploaded reports, and e-prescriptions is being compiled. A download link will be sent to your registered mobile number.',
      [{ text: 'OK' }]
    );
  };
        ...
        <View style={s.section}>
          ...
          <View style={s.cardGroup}>
            <Pressable
              ...
              onPress={() =>
                Alert.alert(
                  'Teleconsultation Consent (PT-03-01)',
                  'Accepted on file: 14 May 2026. Complies with Telemedicine Practice Guidelines and statutory consent standards.'
                )
              }
              accessibilityRole="button"
              accessibilityLabel="Teleconsultation Consent"
            >
              <View style={s.rowIconCircle}>
                <Icon name="shieldCheck" size={18} color={colors.surfie} />
              </View>
              <View style={s.rowTextCol}>
                <Text style={s.rowTitle}>Teleconsultation Consent</Text>
                <Text style={s.rowSub}>Review accepted terms and audit timestamp</Text>
              </View>
              <Icon name="chevronRight" size={18} color={colors.inkFaint} />
            </Pressable>
            ...
            >
              ...
              <View style={s.rowTextCol}>
                ...
                <Text style={s.rowSub}>Request statutory data erasure (PT-03-03)</Text>
              </View>
              <Icon name="chevronRight" size={18} color={colors.inkFaint} />
            </Pressable>
            ...
            >
              <View style={s.rowIconCircle}>
                <Icon name="download" size={18} color={colors.surfie} />
              </View>
              <View style={s.rowTextCol}>
                <Text style={s.rowTitle}>Data Export</Text>
                <Text style={s.rowSub}>Download personal medical archive (PT-21-01)</Text>
              </View>
              <Icon name="chevronRight" size={18} color={colors.inkFaint} />
            </Pressable>
