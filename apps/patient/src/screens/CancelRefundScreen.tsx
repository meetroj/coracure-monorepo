...
import { Screen, StatusPill, Icon } from '@coracure/ui';
...
export const CancelRefundScreen = () => {
  ...
  return (
    <Screen contentStyle={s.container}>
      <ScreenBackground name="cancel" scrolls />
      <FlowHeader action="bell" dot={false} />
      ...
      <View style={s.card}>
        ...
        <View style={s.refundRow}>
          <View style={s.refundCol}>
            <Text style={s.refundLabel}>Total Paid</Text>
        ...
        <View style={s.timeline}>
          ...
          <View style={s.timelineStep}>
            ...
            <View style={s.stepContent}>
              ...
              <Text style={s.stepSub}>You will receive the refund in your original payment method.</Text>
            </View>
          </View>
        </View>
      </View>
